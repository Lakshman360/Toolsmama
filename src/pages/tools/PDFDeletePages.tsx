...
const PDFDeletePages = () => {
  ...
  const processPDF = async () => {
    ...
    if (!pageRange.trim()) {
      setError('Please enter a page range to delete (e.g., 1, 3-5).');
      return;
    }
    ...
    try {
      ...
      const pageIndicesToDelete = parsePageRange(pageRange, totalPages);
      ...
      setError(err instanceof Error ? err.message : 'An error occurred while deleting pages.');
    } finally {
  ...
  return (
    <ToolLayout
      ...
      desc="Remove specific pages from your PDF file."
      icon={Scissors}
      badge="PDF Editor"
    >
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          ...
          {downloadUrl && (
            ...
            >
              <a
                href={downloadUrl}
                download={`modified_${files[0].name}`}
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h3>How to delete pages from your PDF</h3>
          <ol>
            <li>Upload the PDF file you want to remove pages from.</li>
            <li>Enter the page numbers or ranges you want to delete (e.g., "1, 3-5, 10").</li>
            <li>Click "Delete Pages" to generate a new PDF without those pages.</li>
