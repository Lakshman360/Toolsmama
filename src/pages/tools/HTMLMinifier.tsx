...
import { Code, Copy, Check, Trash2, Zap, ShieldCheck, Sparkles } from "lucide-react";
...
export default function HTMLMinifier() {
  ...
  return (
    <ToolLayout
      title="HTML Minifier"
      desc="Compress your HTML code by removing comments and extra spaces."
      icon={Code}
      badge="Developer Tool"
      features={[
        { icon: Sparkles, title: "Fast Loading", desc: "Smaller HTML files mean faster website load times." },
        { icon: Zap, title: "Instant", desc: "Minify your code locally in milliseconds." },
        { icon: ShieldCheck, title: "Private", desc: "Your code never leaves your browser." }
      ]}
    >
      <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl shadow-slate-200/50 space-y-6">
        <div className="space-y-4">
          <h4 className="font-bold text-slate-900 text-sm uppercase tracking-widest">Input HTML</h4>
          <textarea
            value={input}
        ...
        <div className="space-y-4">
          ...
          <textarea
            ...
            className="w-full h-32 p-4 bg-slate-900 text-emerald-400 border border-slate-800 rounded-2xl font-mono text-sm resize-none"
          />
        </div>
      </div>
    </ToolLayout>
